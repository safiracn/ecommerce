...
<div class="max-w-4xl bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
    <div class="p-6 border-b border-slate-100 bg-slate-50/50">
        <h3 class="font-bold text-slate-800">Form Produk Baru</h3>
        <p class="text-xs text-slate-400 mt-1">Masukkan rincian informasi produk peralatan rumah tangga.</p>
    </div>

    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-weight" class="p-6 space-y-6" id="productForm">
        @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Masukkan nama produk (e.g. Sapu Ijuk Premium)">
                    @error('name')
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active', '1') == '1' ? 'checked' : '' }} class="w-4 h-4 rounded text-emerald-600 border-slate-300 focus:ring-emerald-500 focus:ring-offset-0 transition">
            ...
            <div class="space-y-6 flex flex-col justify-between">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Masukkan deskripsi produk secara detail...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-xs font-semibold text-red-600 flex items-center">
                            {{ $message }}
                        </p>
                ...
                <div>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-2xl bg-slate-50/50 hover:bg-slate-50 transition relative">
                        ...
                        <div class="hidden absolute inset-0 w-full h-full p-2 bg-white rounded-2xl flex items-center justify-center" id="previewContainer">
                            <img src="" id="imagePreview" class="max-h-full max-w-full rounded-xl object-contain shadow-sm">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Before sending form, make sure it is sent using multipart/form-data
