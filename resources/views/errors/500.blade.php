...
<head>
    ...
    <title>Kesalahan Server Internal - HomeMart</title>
...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-6">
    <div class="max-w-md w-full text-center space-y-6">
        ...
        <h1 class="text-7xl font-bold text-slate-800">500</h1>
        <h2 class="text-2xl font-bold text-slate-700">Kesalahan Server Internal</h2>
        <p class="text-slate-500 text-sm max-w-sm mx-auto">Maaf, terjadi kesalahan pada server kami saat memproses permintaan Anda.</p>
        <div>
